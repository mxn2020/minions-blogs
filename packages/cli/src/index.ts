...
/**
 * @minions-blogs/cli — CLI for Minions Blogs
 *
...
import { customTypes } from '@minions-blogs/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Blogs'));
        console.log(chalk.dim('Blog definitions, settings, brand voice, and target audience profiles'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-blogs/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-blogs/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-blogs')}`);
